document.addEventListener('DOMContentLoaded', () => {
  ...
  if (footer && !footer.querySelector('.visitor-counter')) {
    ...
    const visitorKey = 'titanTurboVisitorSeen';
    const countKey = 'titanTurboLocalVisits';
    ...
    counter.innerHTML = `<span>${isNewVisitor ? 'NOVO VISITANTE' : 'VISITANTE RECORRENTE'} · ACESSOS NESTE NAVEGADOR: ${currentCount}</span>`;
