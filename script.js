document.addEventListener('DOMContentLoaded', () => {
  ...
  if (footer && !footer.querySelector('.visitor-counter')) {
    ...
    counter.innerHTML = `<span>${isNewVisitor ? 'NOVO VISITANTE' : 'VISITANTE RECORRENTE'}</span>`;
